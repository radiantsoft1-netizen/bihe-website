          ...
          {visibleItems.map((item, index) => (
            <Reveal key={item.id} delay={index * 90} direction="up">
              <article className="news-card">
                <Link href={SITE_LINKS.newsDetail(item.slug)} className="news-card__media media-card__media">
                  <SmartImage
                    src={item.image}
                    alt={item.title}
                    fill
                ...
                <div className="news-card__body">
                  ...
                  <Link href={SITE_LINKS.newsDetail(item.slug)} className="news-card__link">
                    Read more
                    <ArrowRightIcon />
                  </Link>
                </div>
