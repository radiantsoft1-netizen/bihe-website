export const FINANCE_SECTION_PROFILE = {
  name: "F.D.A",
  titleLine: "Finance Section, Bapuji Institute of Hi-Tech Education",
  qualifications: "Fee Administration · Budgeting · Accounts",
} as const;

export const FINANCE_SECTION_BADGE = "Finance Section";

export const FINANCE_SECTION_TITLE = {
  lead: "Effective financial planning &",
  accent: "transparent administration",
} as const;
...
export const FINANCE_SECTION_PAGE_LEAD =
  "Financial planning, transparent fund utilization, and institutional accounts at Bapuji Institute of Hi-Tech Education.";
