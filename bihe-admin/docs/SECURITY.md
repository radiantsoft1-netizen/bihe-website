...
Brief reference for Laravel admin (`bihe-admin/`) and public API hardening.
...
1. **Document root** — point domain to `bihe-admin/public`, not project root (keeps `.env` private).
