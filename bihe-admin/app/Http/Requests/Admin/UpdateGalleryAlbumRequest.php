...
class UpdateGalleryAlbumRequest extends BaseFormRequest
{
    ...
    {
        /** @var GalleryAlbum|null $galleryAlbum */
        $galleryAlbum = $this->route('galleryAlbum');
        ...
        return [
            ...
            'slug' => [
                ...
                'string',
                'max:255',
                Rule::unique('gallery_albums', 'slug')->ignore($galleryAlbum?->id),
            ],
