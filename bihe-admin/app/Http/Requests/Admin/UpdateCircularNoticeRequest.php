...
class UpdateCircularNoticeRequest extends BaseFormRequest
{
    ...
    {
        $noticeId = $this->route('circularNotice')?->id;

        return [
            'title' => ['required', 'string', 'max:255'],
            'slug' => ['nullable', 'string', 'max:255', Rule::unique('circular_notices', 'slug')->ignore($noticeId)],
