<div class="info-corner-form__layout">
    <div class="info-corner-form__column info-corner-form__column--main">
        <section class="info-corner-form__section">
            ...
            <textarea id="message" name="message" class="form-textarea form-input--compact js-rich-text" data-rich-text rows="5" aria-required="true">{{ old('message', optional($announcement ?? null)->message) }}</textarea>
