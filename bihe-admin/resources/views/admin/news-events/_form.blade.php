...
<div class="form-group">
    ...
    <textarea id="summary" name="summary" class="form-textarea js-rich-text" data-rich-text rows="4">{{ old('summary', optional($newsEvent ?? null)->summary ?? '') }}</textarea>
...
<div class="form-group">
    ...
    <textarea id="seo_description" name="seo_description" class="form-textarea js-rich-text" data-rich-text rows="3">{{ old('seo_description', optional($newsEvent ?? null)->seo_description ?? '') }}</textarea>
