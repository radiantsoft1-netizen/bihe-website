<div class="info-corner-form__layout">
    <div class="info-corner-form__column info-corner-form__column--main">
        ...
        <section class="info-corner-form__section info-corner-form__section--editor">
            ...
            <textarea id="subtitle" name="subtitle" class="form-textarea info-corner-form__editor form-input--compact js-rich-text" data-rich-text rows="4" aria-required="true">{{ old('subtitle', optional($heroBanner ?? null)->subtitle ?? '') }}</textarea>
