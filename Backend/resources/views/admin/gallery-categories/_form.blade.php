...
<div class="form-group">
    ...
    <textarea id="description" name="description" class="form-textarea js-rich-text" data-rich-text data-rich-text-height="220" rows="4">{{ old('description', optional($galleryCategory ?? null)->description ?? '') }}</textarea>
