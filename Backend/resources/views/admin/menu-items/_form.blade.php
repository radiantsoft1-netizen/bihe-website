...
<div class="form-group">
    ...
    <textarea id="description" name="description" class="form-input js-rich-text" data-rich-text data-rich-text-height="220" rows="3">{{ old('description', $item?->description ?? '') }}</textarea>
