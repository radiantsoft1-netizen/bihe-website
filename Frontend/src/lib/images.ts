...
export const imageRewriteMap = {
  ...
  "differently-abled-wheelchair-facility":
    "/images/differently-abled-wheelchair-facility.png",
  "differently-abled-ramps-railings":
    "/images/differently-abled-ramps-railings.png",
  "differently-abled-accessible-classrooms":
    "/images/differently-abled-accessible-classrooms.png",
  "differently-abled-scribe-examination":
    "/images/differently-abled-scribe-examination.png",
  "differently-abled-special-teaching":
    "/images/differently-abled-special-teaching.png",
  "differently-abled-library-facilities":
    "/images/differently-abled-library-facilities.png",
  ...
  "international-students-admission-process":
    "/images/international-students-admission-process.png",
  "international-students-eligibility-documents":
    "/images/international-students-eligibility-documents.png",
  "international-students-library-facilities":
    "/images/international-students-library-facilities.png",
  "international-students-facilities": "/images/international-students-facilities.png",
  "international-students-hostel-facilities":
    "/images/international-students-hostel-facilities.png",
  "international-students-lab-facilities": "/images/international-students-lab-facilities.png",
  "international-students-guidance-support":
    "/images/international-students-guidance-support.png",
  "international-students-health-facilities":
    "/images/international-students-health-facilities.png",
...
const short = (slug: ImageSlug) => `/i/${slug}` as const;

/** Short public image URLs — rewritten to /images/* in next.config */
export const images = {
  logo: short("logo"),
  hero: short("hero"),
  ...
  news: [short("news-1"), short("news-2"), short("news-3"), short("news-4")],
  accreditation: [
  ...
  studentLife: {
    ...
    differentlyAbledAccessibleClassrooms: short(
      "differently-abled-accessible-classrooms",
    ),
...
/** Remote Figma sources used by download-assets script and SmartImage fallback */
export const figmaSources: Record<string, string> = {
  ...
  "accreditation-3.webp":
    "https://www.figma.com/api/mcp/asset/ea334caa-dcb3-4ea2-8558-3d328e878a19",
  "accreditation-4.webp":
    "https://www.figma.com/api/mcp/asset/a64af101-b7d8-4c7a-8b26-d3cfc7ad02b2",
  "accreditation-5.webp":
    "https://www.figma.com/api/mcp/asset/ea334caa-dcb3-4ea2-8558-3d328e878a19",
  "recruiter-1.webp":
...
/** Rewrite Laravel /storage URLs to same-origin paths proxied by Next.js. */
